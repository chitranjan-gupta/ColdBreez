...
export default function Disclaimer() {
  return (
    <>
      <Head>
        <title>AajKaNews - Disclaimer</title>
        <meta name="description" content="AajKaNews - Disclaimer" />
      </Head>
      <div
      ...
      <div className="p-5 flex flex-col justify-between items-start">
        <div>
          <li>
            <strong>Disclaimer for AajKaNews.</strong>
          </li>
          <li>
            <strong>
              Disclaimer for <Link href="/">AajKaNews</Link>
            </strong>
          </li>
          <li>
            <strong>
              All the information on this website - AajKaNews - is
              published in good faith and for general information purposes only.
            </strong>
          </li>
        </div>
        AajKaNews does not make any warranties about the completeness,
        reliability, and accuracy of this information. Any action you take upon
        the information you find on this website AajKaNews, is strictly
        at your own risk. AajKaNews will not be liable for any losses and/or
