...
export function Post({ post, postType, showAuthor }) {
  return <div key={post._id} className="max-w-[320px] min-w-[320px] lg:max-w-[370px] lg:min-w-[370px] mx-auto" onClick={() =>
    window.open(
    ...
    <div className="w-full h-full">
      ...
      {showAuthor ? <div className="relative mt-2 flex items-center gap-x-4">
        <Image
        ...
        <div className="text-sm leading-6">
          <p className="font-semibold text-gray-900">
            <Link href={`/${postType}/author/${post.authorSlug.current.trim().toLowerCase()}`} prefetch={false} onClick={(event) => event.stopPropagation()}>
