...
export function generateSiteMap(posts: { _id: any; slug?: { current: string; }; lastModified?: Date; categories: any; subcategories: any; }[]) {
  return `<?xml version="1.0" encoding="UTF-8"?>
     <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
      ...
      <url>
       ...
       ${posts
      .map(({ _id, slug = { current: "" }, lastModified = new Date(), categories, subcategories }) => {
        return `
         <url>
